...
namespace AElf.Contracts.LotteryGame
{
    ...
    public class LotteryGame : LotteryGameContainer.LotteryGameBase
    {
        ...
        {
            // Check if the contract is already instalized
            ...
            // Initialized the token contract
        ...
        // Withdraw a specified amount of tokens from the contract
